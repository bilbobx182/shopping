from common import replace_ownbrand, perform_request, standardise, generate_insert, replace_if, remove_string_from_number
...
class Supervalu():
    ...
    def remove_garbage(self, raw_product):
        ...
        super_product = replace_ownbrand(standardise(' '.join(raw_product[:-1])), "supervalu")
